...
class Game:
    ...
    def checkCollisions(self):
        if len(self.pipes):
            ...
            if (self.bird.rect.colliderect(self.pipes[0].rect_down) or#checking/dead for pipe down
            self.bird.rect.colliderect(self.pipes[0].rect_up)):#checking/dead for pipe up
                self.is_enter_pressed=False
                self.is_game_started=False
